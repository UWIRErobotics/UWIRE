...
#define cfgStartTerminated     0x0900U
#define cfgStartSleeping       0x0960U
#define cfgStartSuspended      0x0920U
#define cfgStartRunning        0x09E0U
 ...
 * pc push. For exmaple, the required stackspace may depend on it.
 */
