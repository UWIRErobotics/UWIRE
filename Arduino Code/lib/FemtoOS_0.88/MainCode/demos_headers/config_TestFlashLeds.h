...
#define  TaskIncludeDefault                      cfgStartRunning
...
#define  CapabilitiesDefault                     cfgCapDelay
...
#define  StackSizeDefault                        4 + 2*defThreeByteStackAdd
...
#define  RegisterUseDefault                      registersNon
...
#define  RegisterCheckDefault                    registersNon
...
#define  InterruptStartDefault                   cfgGlobClear | cfgTickClear
